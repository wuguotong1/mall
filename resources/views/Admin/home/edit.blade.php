        ...
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="username" value="{{ $user->username }}" required="" lay-verify="username" class="layui-input" disabled>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="nikename" required="" lay-verify="username" class="layui-input" value="{{ $user->users->nikename }}">
              </div>
          </div>
         ...
         <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  class="layui-input" value="{{ $user->users->age }}">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  class="layui-input" value="{{ $user->users->phone }}">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  class="layui-input" value="{{ $user->users->email }}">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  class="layui-input" value="{{ $user->users->QQ }}">
              </div>
          </div>
