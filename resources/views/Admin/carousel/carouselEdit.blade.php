...
<div class="x-body">
  <form id="adv_form" class="layui-form" action="/admin/carousel/{{$data->id}}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{method_field('PATCH')}}
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <img src="{{$data->path}}" alt="" style="width:100px;">
                </div>
            </div>
      ...
      <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="radio" name="status" lay-skin="primary" value="0" title="隐藏" @if($data->status == 0) checked @endif>
            <input type="radio" name="status" lay-skin="primary" value="1" title="显示" @if($data->status == 1) checked @endif>
          </div>
      </div>
