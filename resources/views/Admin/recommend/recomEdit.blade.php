...
<a href="/admin/advert" class="layui-btn layui-btn-normal" style="margin-left:20px; margin-top:20px;">返回列表页</a>
    <div class="x-body">
      <form id="adv_form" class="layui-form" action="/admin/advert/update/{{$data->id}}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="hidden" id="old_thumb" name="old_thumb" value="{{$data->recom_thumb}}">
                    <img src="{{$data->recom_thumb}}" id="thumbb" alt="" style="height:55px;">
                </div>
            </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea name="desc" class="layui-input" style="height:80px;">{{$data->desc}}</textarea>
              </div>
          </div>
