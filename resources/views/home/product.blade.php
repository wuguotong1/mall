        ...
        <div class="l_list">        	
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="175" class="jud_per">
                    	<p> <?php if($rate > 0) echo "$rate"; else echo '100'; ?> </p>用户评分
                    </td>
                    <td width="300">
                    	<table border="0" style="width:100%;" cellspacing="0" cellpadding="0">
                          <tr>
                            <td style="width:80px">好评<font color="#999999">（{{$count_high}}/{{$count}}）</font>
                            </td>
                            <td>
                                <img src="/home/images/pl.gif" align="absmiddle"/>
                            </td>
                          </tr>
                          <tr>
                            <td>中评<font color="#999999">（{{$count_midium}}/{{$count}}）</font>
                            </td>
                            <td>
                                <img src="/home/images/pl.gif" align="absmiddle" />
                            </td>
                          ...
                          <tr>
                            <td>差评<font color="#999999">（{{$count_low}}/{{$count}}）</font>
                            </td>
                            <td>
                                <img src="/home/images/pl.gif" align="absmiddle" />
                            </td>
                    ...
                    <td class="jud_bg">您可对已购买商品进行评价<br />
                        ...
                        <a href="/home/index/create">
                            <img src="/home/images/btn_jud.gif" />
                        </a>
                    </td>
                  </tr>
                </table>
                ...
                <table border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                        @foreach($data as $v)
                    <tr>
                        <td class="tm-col-master" data-spm-anchor-id="a220o.1000855.0.i2.3bd36645OaUEi3" style="width:400px">
                        <div class="tm-rate-content">
                            <div class="tm-rate-fulltxt" style="color:#333;font-family:Arial,宋体;font-size:14px">{{ $v->comment }}</div>
                        </div>
                        <div class="tm-rate-date" style="color:#ccc;    font-family: tahoma,arial,\5FAE\8F6F\96C5\9ED1,sans-serif;">{{ $v->created_at }}</div>
                        <div class="tm-rate-reply">
                                <div class="tm-rate-fulltxt" data-spm-anchor-id="a220o.1000855.0.i3.3bd36645OaUEi3" style="color:#AF874D;font-family:Arial,宋体;font-size:14px">商家回复 : {{ $v->reply->reply }}
                                </div>
                            </div>
                        </td>
                        <td class="col-meta">
                            <div class="rate-sku">
                                <p title="网络类型:无需合约版"><span>网络类型：</span>无需合约版</p>
                                    <p title="机身颜色:深空灰色"><span>机身颜色：</span>深空灰色</p>
                                    <p title="套餐类型:官方标配"><span>套餐类型：</span>官方标配</p>
                                    <p title="存储容量:64GB"><span>存储容量：</span>64GB</p>
                                </div>
                                    ...
                                    <div class="rate-user-grade">
                                        ...
                                        <p class="gold-user" style="font-family:Arial,宋体"">
                                            <?php 
                                                ...
                                                elseif($v->user->score>=10 && $v->user->score<20) echo '<img src="/home/rank/a2.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=20 && $v->user->score<30) echo '<img src="/home/rank/a3.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=30 && $v->user->score<50) echo '<img src="/home/rank/a4.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=50 && $v->user->score<70) echo '<img src="/home/rank/a5.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=70 && $v->user->score<100) echo '<img src="/home/rank/a6.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=100 && $v->user->score<130) echo '<img src="/home/rank/m1.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=130 && $v->user->score<160) echo '<img src="/home/rank/m2.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=160 && $v->user->score<195) echo '<img src="/home/rank/m3.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=195 && $v->user->score<235) echo '<img src="/home/rank/m4.png" style="width:80px;height:22px">';
                                                elseif($v->user->score>=235 && $v->user->score<300) echo '<img src="/home/rank/m5.png" style="width:80px;height:22px">';
                                                 elseif($v->user->score>=300 && $v->user->score<400) echo '<img src="/home/rank/m6.png" style="width:80px;height:22px">';
                                            ?>
                                            <!-- 积分制度
                                            0-10  a1
                                            10-20 a2
